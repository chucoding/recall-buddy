      ...
      <div className="terms-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="terms-modal-content">
          {termsType === 'terms' ? (
            <>
              <h3>제1조 (목적)</h3>
              <p>본 약관은 Today I Learned(이하 "서비스")의 이용과 관련하여 서비스와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>

              <h3>제2조 (정의)</h3>
              <p>1. "서비스"란 Today I Learned가 제공하는 학습 관리 및 플래시카드 서비스를 의미합니다.</p>
            ...
            <>
              ...
              <p>Today I Learned는 다음의 목적을 위하여 개인정보를 처리합니다:</p>
              ...
              <p>개인정보 보호책임자: Today I Learned 운영팀</p>
